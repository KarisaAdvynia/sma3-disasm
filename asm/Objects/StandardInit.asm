...
ldr   r1,=ObjA5_A6_Tileset3Widths   ; 0801AA02
...
ldrh  r3,[r0]                       ; 0801B444  object ID
mov   r0,0x3                        ; 0801B446
and   r0,r3                         ; 0801B448  objID-5C
ldr   r3,=Obj5C_5E_Slopes           ; 0801B44A
lsl   r0,r0,0x1                     ; 0801B44C
add   r0,r0,r3                      ; 0801B44E  index with objID-5C
ldrh  r3,[r0]                       ; 0801B450
mov   r0,r12                        ; 0801B452
...
ldrh  r3,[r0]                       ; 0801B4B0  object ID
mov   r0,0x3                        ; 0801B4B2
and   r0,r3                         ; 0801B4B4  objID-58
sub   r0,0x1                        ; 0801B4B6  objID-59
lsl   r0,r0,0x10                    ; 0801B4B8
ldr   r3,=Obj59_5B_Slopes           ; 0801B4BA
lsr   r0,r0,0xF                     ; 0801B4BC
add   r0,r0,r3                      ; 0801B4BE  index with objID-59
ldrh  r3,[r0]                       ; 0801B4C0
mov   r0,r12                        ; 0801B4C2
...
strh  r0,[r3]                       ; 0801B582  no relative Y threshold
mov   r0,r12                        ; 0801B584
add   r0,0x42                       ; 0801B586
ldrh  r3,[r0]                       ; 0801B588  object ID
mov   r0,0x3                        ; 0801B58A
and   r0,r3                         ; 0801B58C  objID-54
ldr   r3,=Obj54_56_Slopes           ; 0801B58E
lsl   r0,r0,0x1                     ; 0801B590
add   r0,r0,r3                      ; 0801B592  index with objID-54
ldrh  r3,[r0]                       ; 0801B594
mov   r0,r12                        ; 0801B596
add   r0,0x44                       ; 0801B598
strh  r3,[r0]                       ; 0801B59A  set slope
mov   r0,r12                        ; 0801B59C
...
ldr   r3,=Obj4B_4D_Widths           ; 0801B69C
...
mov   r0,0x2                        ; 0801B744
strh  r0,[r3]                       ; 0801B746  set relative Y threshold to 2
sub   r3,0x4                        ; 0801B748  +42
ldrh  r3,[r3]                       ; 0801B74A  object ID
and   r0,r3                         ; 0801B74C  0,2 for 45,46
lsl   r0,r0,0x10                    ; 0801B74E
ldr   r3,=Obj45_46_Slopes           ; 0801B750
lsr   r0,r0,0x11                    ; 0801B752
lsl   r0,r0,0x1                     ; 0801B754
add   r0,r0,r3                      ; 0801B756  offset with 0,2 for 45,46
ldrh  r3,[r0]                       ; 0801B758  -1 for 45, 1 for 46
mov   r0,r12                        ; 0801B75A
add   r0,0x44                       ; 0801B75C
strh  r3,[r0]                       ; 0801B75E  set slope
mov   r5,r12                        ; 0801B760
add   r5,0x48                       ; 0801B762
ldrh  r4,[r5]                       ; 0801B764  YXyx
ldr   r3,=0xF0F0                    ; 0801B766
mov   r0,r3                         ; 0801B768
and   r0,r4                         ; 0801B76A
sub   r0,0x10                       ; 0801B76C  subtract 1 from object y
and   r0,r3                         ; 0801B76E
ldr   r3,=0x0F0F                    ; 0801B770
and   r3,r4                         ; 0801B772
orr   r3,r0                         ; 0801B774
strh  r3,[r5]                       ; 0801B776  set new YXyx
mov   r3,r12                        ; 0801B778
add   r3,0x52                       ; 0801B77A
ldrh  r0,[r3]                       ; 0801B77C \
add   r0,0x1                        ; 0801B77E | add 1 to height
strh  r0,[r3]                       ; 0801B780 /
mov   r0,r12                        ; 0801B782
...
mov   r3,0x0                        ; 0801B7A6
strh  r3,[r0,0x3A]                  ; 0801B7A8  clear scratch RAM
