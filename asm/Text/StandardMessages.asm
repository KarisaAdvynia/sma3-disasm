...
.byte 0xFF,0xFF
Message1_2_FirstMiddleRing:     ; 082F36F2
.strn "@{05}This is the"
...
.strn "@{0A}teamwork of the Yoshi clan\{, }"
.strn "@{0A}the brothers are reunited\{. }"
.strn "@{0A}"
.strn "@{0A}Yoshi frees the captured"
.strn "@{0A}stork\{, } who sets about"
.strn "@{0A}his duty and finally makes"
.strn "@{0A}the long-awaited delivery!"
.strn "@{0A}"
.strn "@{0A}"
.strn "@{0A}Thanks\{, } Yoshi!"
.strn "@{0A}"
.strn "@{0A}The brothers will meet"
.strn "@{0A}their parents soon!"
.byte 0xFF,0xFF
