...
ldr   r0,=0x03007240      ; 08049E82  Normal gameplay IWRAM (0300220C)
ldr   r1,[r0]             ; 08049E84
...
ldr   r0,=0x03007240      ; 0804A062  Normal gameplay IWRAM (0300220C)
ldr   r1,[r0]             ; 0804A064
...
ldr   r0,=0x03007240      ; 0804A1AA  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804A1AC
mov   r4,0x95             ; 0804A1AE
lsl   r4,r4,0x2           ; 0804A1B0  0254
add   r2,r0,r4            ; 0804A1B2
mov   r4,0x0              ; 0804A1B4
cmp   r4,r1               ; 0804A1B6
...
ldr   r0,=0x03007240      ; 0804A202  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804A204
...
ldr   r2,=0x03007240      ; 0804A26A  Normal gameplay IWRAM (0300220C)
...
ldr   r0,=0x03007240      ; 0804A2B2  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804A2B4
...
mov   r4,r1               ; 0804A2F6
ldr   r1,=0x03007240      ; 0804A2F8  Normal gameplay IWRAM (0300220C)
...
ldr   r0,=0x03007240      ; 0804A32A  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804A32C
...
ldr   r0,=0x03007240      ; 0804A36A  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804A36C
...
bl    Sub08047B04         ; 0804A3C0
lsl   r0,r0,0x18          ; 0804A3C4
lsr   r0,r0,0x18          ; 0804A3C6
ldr   r2,=0x03007240      ; 0804A3C8  Normal gameplay IWRAM (0300220C)
...
ldr   r3,=0x03007240      ; 0804A408  Normal gameplay IWRAM (0300220C)
...
bl    Sub08047B04         ; 0804A42C
lsl   r0,r0,0x18          ; 0804A430
lsr   r0,r0,0x18          ; 0804A432
mov   r4,r0               ; 0804A434
ldr   r1,=0x03007240      ; 0804A436  Normal gameplay IWRAM (0300220C)
...
mov   r3,r0               ; 0804A49E
ldr   r7,=0x03007240      ; 0804A4A0  Normal gameplay IWRAM (0300220C)
ldr   r0,[r7]             ; 0804A4A2
...
Sub0804A51C:
push  {r4,lr}             ; 0804A51C
ldr   r1,=0x03007240      ; 0804A51E  Normal gameplay IWRAM (0300220C)
ldr   r3,[r1]             ; 0804A520
ldr   r1,[r0]             ; 0804A522
...
ldr   r5,=0x03007240      ; 0804A55E  Normal gameplay IWRAM (0300220C)
...
ldr   r5,=0x03007240      ; 0804A5A6  Normal gameplay IWRAM (0300220C)
ldr   r1,[r5]             ; 0804A5A8
...
Sub0804A63C:
push  {r4,lr}             ; 0804A63C
ldr   r2,=0x03007240      ; 0804A63E  Normal gameplay IWRAM (0300220C)
ldr   r3,[r2]             ; 0804A640
...
ldr   r0,=0x03007240      ; 0804A72A  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804A72C
...
bl    Sub08047B04         ; 0804A90C
lsl   r0,r0,0x18          ; 0804A910
lsr   r0,r0,0x18          ; 0804A912
ldr   r2,=0x03007240      ; 0804A914  Normal gameplay IWRAM (0300220C)
...
bl    Sub08047B04         ; 0804A94E
lsl   r0,r0,0x18          ; 0804A952
lsr   r0,r0,0x18          ; 0804A954
ldr   r2,=0x03007240      ; 0804A956  Normal gameplay IWRAM (0300220C)
...
Sub0804A9B8:
push  {r4,lr}             ; 0804A9B8
ldr   r1,=0x03007240      ; 0804A9BA  Normal gameplay IWRAM (0300220C)
ldr   r3,[r1]             ; 0804A9BC
ldr   r1,[r0]             ; 0804A9BE
...
and   r1,r3               ; 0804AA1E
ldr   r2,=0x03007240      ; 0804AA20  Normal gameplay IWRAM (0300220C)
ldr   r2,[r2]             ; 0804AA22
...
mov   r4,r0               ; 0804AAA2
ldr   r0,=0x03007240      ; 0804AAA4  Normal gameplay IWRAM (0300220C)
ldr   r3,[r0]             ; 0804AAA6
ldr   r0,[r4]             ; 0804AAA8
ldr   r2,[r1]             ; 0804AAAA
...
bl    Sub08047B04         ; 0804AAFC
lsl   r0,r0,0x18          ; 0804AB00
lsr   r0,r0,0x18          ; 0804AB02
ldr   r2,=0x03007240      ; 0804AB04  Normal gameplay IWRAM (0300220C)
...
bl    Sub08047B04         ; 0804AB5C
lsl   r0,r0,0x18          ; 0804AB60
lsr   r0,r0,0x18          ; 0804AB62
ldr   r2,=0x03007240      ; 0804AB64  Normal gameplay IWRAM (0300220C)
...
ldr   r0,=0x03007240      ; 0804B2F6  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804B2F8
...
Sub0804B3B8:
; Load a 16x16 dynamic sprite's graphics, into the top-left corner of its dynamic slot
...
Sub0804B534:
push  {lr}                ; 0804B534
ldr   r1,=0x03007240      ; 0804B536  Normal gameplay IWRAM (0300220C)
ldr   r2,[r1]             ; 0804B538
...
mov   r4,r0               ; 0804B5B2
ldr   r0,=0x03007240      ; 0804B5B4  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804B5B6
...
add   r6,r0,r1            ; 0804B5C2
ldrh  r0,[r6]             ; 0804B5C4
ldr   r5,=0x012B          ; 0804B5C6
mov   r1,0xD1             ; 0804B5C8
lsl   r1,r1,0x1           ; 0804B5CA
cmp   r0,r5               ; 0804B5CC
...
strb  r0,[r1]             ; 0804B612
@Code0804B614:
ldr   r0,=0x03007240      ; 0804B614  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804B616
...
mov   r5,r0               ; 0804B666
ldr   r4,=0x03007240      ; 0804B668  Normal gameplay IWRAM (0300220C)
ldr   r2,[r4]             ; 0804B66A
ldr   r0,[r5]             ; 0804B66C
...
ldr   r0,=0x03007240      ; 0804B7C2  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804B7C4
...
ldr   r2,=0x03007240      ; 0804B81C  Normal gameplay IWRAM (0300220C)
...
strh  r1,[r0]             ; 0804B862
@Code0804B864:
ldr   r2,=0x03007240      ; 0804B864  Normal gameplay IWRAM (0300220C)
...
ldr   r0,=0x03007240      ; 0804B8E8  Normal gameplay IWRAM (0300220C)
ldr   r2,[r0]             ; 0804B8EA
ldr   r0,[r4]             ; 0804B8EC
...
@Code0804B912:
ldr   r2,=0x03007240      ; 0804B912  Normal gameplay IWRAM (0300220C)
...
ldrh  r0,[r1]             ; 0804BA08
cmp   r6,r0               ; 0804BA0A
bne   @Code0804BA20       ; 0804BA0C
mov   r0,0x0              ; 0804BA0E
strh  r0,[r1]             ; 0804BA10
b     @Code0804BA20       ; 0804BA12
.pool                     ; 0804BA14
...
beq   @Code0804BA44       ; 0804BA2E
ldr   r0,=0x0133          ; 0804BA30
cmp   r1,r0               ; 0804BA32
beq   @Code0804BA44       ; 0804BA34
sub   r0,0x9              ; 0804BA36
cmp   r1,r0               ; 0804BA38
beq   @Code0804BA44       ; 0804BA3A
cmp   r1,0x9B             ; 0804BA3C
beq   @Code0804BA44       ; 0804BA3E
cmp   r1,0x74             ; 0804BA40
bne   @Code0804BA4C       ; 0804BA42
@Code0804BA44:
mov   r0,0x0              ; 0804BA44
b     @Code0804BA4E       ; 0804BA46
.pool                     ; 0804BA48
...
cmp   r1,r0               ; 0804BA5C
beq   @Code0804BA64       ; 0804BA5E
mov   r0,0x1              ; 0804BA60
b     @Code0804BA66       ; 0804BA62
@Code0804BA64:
mov   r0,0x0              ; 0804BA64
@Code0804BA66:
pop   {r1}                ; 0804BA66
...
cmp   r0,0x0              ; 0804BA7E
beq   @Code0804BA9C       ; 0804BA80
mov   r0,r4               ; 0804BA82
bl    Sub0804BA54         ; 0804BA84
cmp   r0,0x0              ; 0804BA88
beq   @Code0804BA9C       ; 0804BA8A
mov   r0,r4               ; 0804BA8C
mov   r1,r5               ; 0804BA8E
bl    Sub0804B9A4         ; 0804BA90
mov   r0,0x0              ; 0804BA94
b     @Code0804BA9E       ; 0804BA96
@Code0804BA98:
mov   r0,0x7              ; 0804BA98
...
cmp   r2,0x0              ; 0804BAB4
blt   @Code0804BB3E       ; 0804BAB6
ldr   r1,=0x03007240      ; 0804BAB8  Normal gameplay IWRAM (0300220C)
...
cmp   r2,0x0              ; 0804BB56
blt   @Code0804BB7A       ; 0804BB58
ldr   r1,=0x03007240      ; 0804BB5A  Normal gameplay IWRAM (0300220C)
...
@Code0804BBD8:
cmp   r0,0x0              ; 0804BBD8
beq   @Code0804BC14       ; 0804BBDA
sub   r0,0x1              ; 0804BBDC
ldr   r1,=0x03007240      ; 0804BBDE  Normal gameplay IWRAM (0300220C)
...
cmp   r0,0x8              ; 0804BBF4
bne   @Code0804BC14       ; 0804BBF6
mov   r0,r1               ; 0804BBF8
add   r0,0x5E             ; 0804BBFA
ldrh  r0,[r0]             ; 0804BBFC
cmp   r0,0x0              ; 0804BBFE
beq   @Code0804BC14       ; 0804BC00
mov   r0,r1               ; 0804BC02
mov   r1,r2               ; 0804BC04
...
cmp   r2,0x0              ; 0804BE24
blt   @Code0804BEA8       ; 0804BE26
ldr   r1,=0x03007240      ; 0804BE28  Normal gameplay IWRAM (0300220C)
...
and   r0,r1               ; 0804BE5C
cmp   r0,0x0              ; 0804BE5E
bne   @Code0804BEA8       ; 0804BE60
mov   r0,r5               ; 0804BE62
mov   r1,r2               ; 0804BE64
bl    Sub0804BA6C         ; 0804BE66
cmp   r0,0x0              ; 0804BE6A
bne   @Code0804BEA8       ; 0804BE6C
@Code0804BE6E:
...
cmp   r3,0x0              ; 0804C2B0
blt   @Code0804C320       ; 0804C2B2
ldr   r1,=0x03007240      ; 0804C2B4  Normal gameplay IWRAM (0300220C)
...
and   r0,r1               ; 0804C2E8
cmp   r0,0x0              ; 0804C2EA
bne   @Code0804C320       ; 0804C2EC
mov   r0,r2               ; 0804C2EE
mov   r1,r3               ; 0804C2F0
bl    Sub0804BA6C         ; 0804C2F2
cmp   r0,0x0              ; 0804C2F6
bne   @Code0804C320       ; 0804C2F8
@Code0804C2FA:
...
orr   r0,r1               ; 0804C354
cmp   r0,0x0              ; 0804C356
bne   @Code0804C370       ; 0804C358
mov   r0,0x0              ; 0804C35A
b     @Code0804C372       ; 0804C35C
.pool                     ; 0804C35E
...
ldrh  r0,[r0]             ; 0804C49C
cmp   r0,0x0              ; 0804C49E
beq   @Code0804C4AA       ; 0804C4A0
mov   r0,r1               ; 0804C4A2
bl    Sub0804BCB8         ; 0804C4A4
b     @Code0804C4AC       ; 0804C4A8
@Code0804C4AA:
mov   r0,0x0              ; 0804C4AA
@Code0804C4AC:
pop   {r1}                ; 0804C4AC
...
cmp   r0,0x0              ; 0804C4BE
bge   @Code0804C4E2       ; 0804C4C0
ldr   r0,=0x03007240      ; 0804C4C2  Normal gameplay IWRAM (0300220C)
ldr   r1,[r0]             ; 0804C4C4
...
lsl   r1,r1,0x7           ; 0804C4D6
and   r1,r0               ; 0804C4D8
lsr   r1,r1,0x4           ; 0804C4DA
mov   r0,r4               ; 0804C4DC
bl    Sub080D5B74         ; 0804C4DE
@Code0804C4E2:
pop   {r4}                ; 0804C4E2
pop   {r0}                ; 0804C4E4
bx    r0                  ; 0804C4E6
...
lsl   r0,r0,0x2           ; 0804C53A
add   r5,r1,r0            ; 0804C53C
ldrh  r0,[r5]             ; 0804C53E
add   r0,0x2              ; 0804C540
lsl   r0,r0,0x10          ; 0804C542
lsr   r2,r0,0x10          ; 0804C544
ldr   r0,=0x024A          ; 0804C546
add   r6,r1,r0            ; 0804C548
ldr   r1,=0x03007240      ; 0804C54A  Normal gameplay IWRAM (0300220C)
mov   r12,r1              ; 0804C54C
mov   r0,0x72             ; 0804C54E
add   r0,r0,r4            ; 0804C550
mov   r8,r0               ; 0804C552
...
lsl   r2,r2,0x2           ; 0804C57A
add   r0,r0,r2            ; 0804C57C
mov   r2,r12              ; 0804C57E
ldr   r1,[r2]             ; 0804C580
add   r2,r1,r0            ; 0804C582
mov   r1,0x0              ; 0804C584
mov   r0,0x7              ; 0804C586
strh  r0,[r2,0x24]        ; 0804C588
mov   r0,r2               ; 0804C58A
add   r0,0x5E             ; 0804C58C
strh  r1,[r0]             ; 0804C58E
add   r0,0x1C             ; 0804C590
strh  r1,[r0]             ; 0804C592
sub   r0,0x4              ; 0804C594
strh  r1,[r0]             ; 0804C596
sub   r0,0x4              ; 0804C598
...
sub   r0,0x4              ; 0804C5A0
strh  r1,[r0]             ; 0804C5A2
ldr   r1,=Data08171FB0    ; 0804C5A4
add   r0,0x35             ; 0804C5A6
ldrb  r0,[r0]             ; 0804C5A8
lsr   r0,r0,0x1           ; 0804C5AA
lsl   r0,r0,0x2           ; 0804C5AC
add   r0,r0,r1            ; 0804C5AE
ldr   r0,[r0]             ; 0804C5B0
str   r0,[r2,0x8]         ; 0804C5B2
ldr   r0,=0xFFFFFC00      ; 0804C5B4
str   r0,[r2,0xC]         ; 0804C5B6
mov   r0,0x40             ; 0804C5B8
str   r0,[r2,0x14]        ; 0804C5BA
mov   r3,0x2              ; 0804C5BC
ldrh  r0,[r5]             ; 0804C5BE
cmp   r3,r0               ; 0804C5C0
...
lsl   r2,r2,0x2           ; 0804C5FC
add   r0,r1,r2            ; 0804C5FE
strh  r3,[r0]             ; 0804C600
cmp   r3,0x3              ; 0804C602
bls   @Code0804C644       ; 0804C604
@Code0804C606:
sub   r0,r3,0x4           ; 0804C606
...
lsl   r1,r1,0x2           ; 0804C618
add   r0,r0,r1            ; 0804C61A
mov   r2,r12              ; 0804C61C
ldr   r1,[r2]             ; 0804C61E
add   r2,r1,r0            ; 0804C620
ldrh  r0,[r2,0x32]        ; 0804C622
cmp   r0,0x27             ; 0804C624
beq   @Code0804C62C       ; 0804C626
cmp   r0,0x29             ; 0804C628
bne   @Code0804C644       ; 0804C62A
@Code0804C62C:
mov   r0,r2               ; 0804C62C
add   r0,0x72             ; 0804C62E
strh  r3,[r0]             ; 0804C630
...
ldr   r6,=0x03007240      ; 0804C762  Normal gameplay IWRAM (0300220C)
mov   r5,r1               ; 0804C764
@Code0804C766:
...
ldr   r0,=0x03007240      ; 0804C95C  Normal gameplay IWRAM (0300220C)
ldr   r2,[r0]             ; 0804C95E
...
push  {r7}                ; 0804C9A8
add   sp,-0x4             ; 0804C9AA
ldr   r1,=0x03007240      ; 0804C9AC  Normal gameplay IWRAM (0300220C)
ldr   r0,[r1]             ; 0804C9AE
...
ldr   r3,=0x03007240      ; 0804CCD4  Normal gameplay IWRAM (0300220C)
ldr   r1,[r3]             ; 0804CCD6
mov   r0,r7               ; 0804CCD8
...
eor   r0,r3               ; 0804CD9E
strh  r0,[r6]             ; 0804CDA0
ldr   r2,=0x03007240      ; 0804CDA2  Normal gameplay IWRAM (0300220C)
ldr   r1,[r2]             ; 0804CDA4
...
@Code0804CF80:
ldr   r0,=0x03007240      ; 0804CF80  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804CF82
...
mov   r9,r2               ; 0804D07E
ldr   r0,=0x03007240      ; 0804D080  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804D082
...
ldr   r0,=0x03007240      ; 0804D152  Normal gameplay IWRAM (0300220C)
ldr   r1,[r0]             ; 0804D154
...
ldr   r0,=0x03007240      ; 0804D3D2  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804D3D4
...
ldr   r0,=0x03007240      ; 0804D53A  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804D53C
...
@Code0804D584:
ldr   r0,=0x03007240      ; 0804D584  Normal gameplay IWRAM (0300220C)
ldr   r1,[r0]             ; 0804D586
mov   r0,r3               ; 0804D588
...
str   r0,[sp]             ; 0804D5CC
ldr   r3,=0x03007240      ; 0804D5CE  Normal gameplay IWRAM (0300220C)
ldr   r6,[r3]             ; 0804D5D0
...
ldr   r3,=0x03007240      ; 0804D730  Normal gameplay IWRAM (0300220C)
ldr   r1,[r3]             ; 0804D732
...
@Code0804D750:
ldr   r7,=0x03007240      ; 0804D750  Normal gameplay IWRAM (0300220C)
mov   r8,r7               ; 0804D752
mov   r7,0x1              ; 0804D754
...
@Code0804D81A:
ldr   r1,=0x03007240      ; 0804D81A  Normal gameplay IWRAM (0300220C)
ldr   r0,[r1]             ; 0804D81C
...
ldr   r3,=0x03007240      ; 0804DA60  Normal gameplay IWRAM (0300220C)
...
ldr   r0,=0x03007240      ; 0804DBA6  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804DBA8
...
ldr   r0,=0x03007240      ; 0804DBCC  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804DBCE
...
add   sp,-0x4             ; 0804DC56
mov   r7,r0               ; 0804DC58
ldr   r5,=0x03007240      ; 0804DC5A  Normal gameplay IWRAM (0300220C)
ldr   r0,[r5]             ; 0804DC5C
...
@Code0804E1D4:
ldr   r1,=0x03007240      ; 0804E1D4  Normal gameplay IWRAM (0300220C)
...
ldr   r0,=0x03007240      ; 0804E228  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]             ; 0804E22A
...
@Code0804E282:
ldr   r1,=0x03007240      ; 0804E282  Normal gameplay IWRAM (0300220C)
...
ldr   r4,=0x03007240      ; 0804E30C  Normal gameplay IWRAM (0300220C)
ldr   r2,[r4]             ; 0804E30E
ldr   r0,[r7]             ; 0804E310
...
mov   r5,r0               ; 0804E50E
ldr   r0,=0x03007240      ; 0804E510  Normal gameplay IWRAM (0300220C)
ldr   r4,[r0]             ; 0804E512
...
mov   r5,r0               ; 0804E55A
ldr   r6,=0x03007240      ; 0804E55C  Normal gameplay IWRAM (0300220C)
ldr   r4,[r6]             ; 0804E55E
