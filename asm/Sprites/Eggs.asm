...
ldr   r1,=0x03007240            ; 080503C6  Normal gameplay IWRAM (0300220C)
ldr   r4,[r1]                   ; 080503C8
...
strh  r0,[r1]                   ; 0805044C
@@Code0805044E:
ldr   r1,=0x03007240            ; 0805044E  Normal gameplay IWRAM (0300220C)
ldr   r0,[r1]                   ; 08050450
...
b     @@Code08050964            ; 0805045E
@@Code08050460:
mov   r0,0x0                    ; 08050460
strh  r0,[r1]                   ; 08050462
b     @@Code08050964            ; 08050464
.pool                           ; 08050466
...
mov   r8,r0                     ; 080504E0
ldr   r1,=0x03007240            ; 080504E2  Normal gameplay IWRAM (0300220C)
ldr   r0,[r1]                   ; 080504E4
...
ldr   r3,=0x03007240            ; 08050522  Normal gameplay IWRAM (0300220C)
ldr   r0,[r3]                   ; 08050524
...
ldr   r4,=0x03007240            ; 0805071C  Normal gameplay IWRAM (0300220C)
ldr   r0,[r4]                   ; 0805071E
...
orr   r0,r1                     ; 08050B34
cmp   r0,0x0                    ; 08050B36
bne   @@Code08050B50            ; 08050B38
mov   r0,0x0                    ; 08050B3A
b     @@Code08050B52            ; 08050B3C
.pool                           ; 08050B3E
...
ldr   r0,=0x03007240            ; 08050FB6  Normal gameplay IWRAM (0300220C)
ldr   r0,[r0]                   ; 08050FB8
ldr   r2,=0x2A10                ; 08050FBA
add   r0,r0,r2                  ; 08050FBC
ldrh  r0,[r0]                   ; 08050FBE
cmp   r0,0x0                    ; 08050FC0
bne   @@Code08051096            ; 08050FC2
...
cmp   r0,0x0                    ; 080510C0
bge   @@Code080510D2            ; 080510C2
mov   r0,r5                     ; 080510C4
bl    Sub0804C7E0               ; 080510C6
b     @@Code080510D2            ; 080510CA
@@Code080510CC:
mov   r0,r5                     ; 080510CC
